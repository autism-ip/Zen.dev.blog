export const GradientBg = () => (
  <div className="absolute top-0 z-0 size-full bg-white">
    <div className="absolute top-0 right-0 bottom-auto left-auto size-[500px] translate-x-[-30%] translate-y-[20%] rounded-full bg-purple-500/50 opacity-50 blur-[80px]"></div>
  </div>
)
